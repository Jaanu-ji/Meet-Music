...
type Nav = NativeStackNavigationProp<RootStackParamList, 'JoinCategory'>;

const CATEGORIES = [
  {
    emoji: '🎵',
    title: 'Music Artist',
    description: 'Guitar, Piano, Vocals, DJ, Band and more',
    color: '#7c3aed',
    screen: 'JoinAsArtist' as keyof RootStackParamList,
    delay: 100,
  },
  {
    emoji: '💃',
    ...
    color: '#ec4899',
    screen: 'JoinAsDanceArtist' as keyof RootStackParamList,
    delay: 200,
  },
];

export function JoinCategoryScreen() {
      ...
      <View style={styles.header}>
        <Animated.View entering={FadeInLeft.duration(400)} style={styles.headerLeft}>
          ...
          <View>
            ...
            <Text style={styles.headerSub}>What type of artist are you?</Text>
          </View>
        </Animated.View>
      </View>
